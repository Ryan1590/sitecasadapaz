...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container-fluid mt-4 p-4">
        ...
        <form action="<?php echo e(route('banners-galeria.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card shadow-md rounded-lg p-4" style="height: 250px;">
                        ...
                        <?php if(isset($img) && $img->banner_principal): ?>
                            ...
                            <button type="button" class="btn btn-danger btn-sm mt-3" onclick="confirmDeleteBanner('<?php echo e($img->id); ?>', 'banner_principal')">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card shadow-md rounded-lg p-4" style="height: 250px;">
                        ...
                        <?php if(isset($img) && $img->banner_principal_mobile): ?>
                            ...
                            <button type="button" class="btn btn-danger btn-sm" onclick="confirmDeleteBanner('<?php echo e($img->id); ?>', 'banner_principal_mobile')">
                                <i class="fa fa-trash"></i> Excluir
                            </button>
                        <?php endif; ?>
        ...
        <div class="tab-content" id="galeriaTabsContent">
            ...
            <div class="tab-pane fade show active" id="imagens" role="tabpanel" aria-labelledby="imagens-tab">
                <div class="d-flex justify-content-between mb-4">
                    ...
                    <form method="GET" action="<?php echo e(route('galeria.index')); ?>" class="d-flex align-items-center mb-4">
                        <div class="me-2">
                ...
                <form id="form-excluir-selecionados" method="POST" action="<?php echo e(route('galeria.excluir-selecionados')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <?php if(isset($galeria) && $galeria->isNotEmpty()): ?>
                                ...
                                <div class="col-md-3 mb-4 mt-4">
                                    <div class="card" style="border: none; height: 350px;">
                                        <div class="form-check position-absolute m-2">
                                            <input type="checkbox" class="form-check-input imagem-checkbox" name="imagens[]" value="<?php echo e($item->id); ?>">
                                        </div>
                                        <div class="card-img-top" style="height: 100%; overflow: hidden; display: flex; align-items: center;">
                                            <img src="<?php echo e(asset('storage/' . $item->arquivo)); ?>" class="img-fluid w-100 h-100" style="object-fit: cover;">
                                        </div>
                                        <button type="button" class="btn btn-danger btn-sm w-100" onclick="confirmDelete('<?php echo e($item->id); ?>')">
                                            <i class="fa fa-trash"></i> Excluir
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="tab-pane fade" id="eventos" role="tabpanel" aria-labelledby="eventos-tab">
                <?php echo $__env->make('galeria.evento', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
        ...
        <div class="modal fade" id="addArquivoModal" tabindex="-1" aria-labelledby="addArquivoModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?php echo e(route('galeria.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
        ...
        function confirmDeleteBanner(id, type) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`<?php echo e(url('/imagens')); ?>/${id}/remover/galeria`, {
                        method: 'POST',
                        headers: {
...
<?php endif; ?>
<?php /**PATH C:\Users\ryan.rodrigues\Documents\PainelAdmCasadapaz\resources\views/galeria/index.blade.php ENDPATH**/ ?>